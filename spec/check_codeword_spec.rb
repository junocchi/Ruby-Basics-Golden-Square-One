...
RSpec.describe "check_codeword method" do
  ...
  it "returns a wrong message if only the given word's first letter is right" do
    result = check_codeword("hello")
    expect(result).to eq "WRONG!"
  end

  it "returns a wrong message if only the given word's last letter is right" do
